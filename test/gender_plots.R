...
png("plots/Gender_Pronoun_Percentages.png",width=800,height=350, unit= 'px')
...
png("plots/Tool_Use_by_PGP.png",width=700,height=500, unit= 'px')
...
png("plots/Tool_Confidence_by_PGP.png",width=700,height=500, unit= 'px')
